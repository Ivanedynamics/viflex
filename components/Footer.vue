    ...
    >
      <section>
        <div class="flex flex-col gap-3">
          ...
          <p class="text-white text-sm max-w-[325px]">
      ...
      <section>
        <p class="font-bold text-white text-lg">Contacto</p>
        <ul class="flex flex-col items-start gap-4 w-fit">
          <li>
            <a
              class="text-white m-0 p-0 flex flex-row gap-2"
              :href="`https://wa.me/${CONTACT_COFING.whatsapp?.format}`"
              target="_blank"
            >
              <svg
      ...
      <!-- <section class="flex flex-row w-full justify-between">
        <p class="text-[#c6c6c6] text-sm">
          Todos los derechos reservados @Viflex

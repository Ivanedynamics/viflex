...
<template>
  ...
  >
    ...
    >
      ...
      <div
        class="flex-row items-center gap-4 mobile_s:flex tablet:grid tablet:grid-cols-[auto,1fr,auto]"
      >
        <a
          :href="`tel:${CONTACT_COFING.phonenumber.value}`"
          class="flex flex-row items-center gap-2 mobile_s:hidden tablet:flex"
        >
          <svg
            width="30"
            height="30"
          ...
          <div class="flex flex-col">
            <p class="text-xs text-gray-100">Llama cuando quieras</p>
